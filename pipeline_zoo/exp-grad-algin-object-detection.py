...
def run_attack(
    ...
    for step in range(steps):
        ...
        cos_sim = F.cosine_similarity(g_cls.flatten(), g_area.flatten(), dim=0)
        align_loss = -cos_sim  # maximize alignment
        λ_align = 0.01
        total_loss = layer1_cls_loss + norm_loss - layer1_area_loss + λ_align * align_loss
        total_loss.backward()
