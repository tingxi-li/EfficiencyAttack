...
class Pipeline(BasePipeline):
    """Phase A: optimize model_1 only; run model_2 in no_grad for counting only."""
    ...
    def _attack_step(self, i, image_tensor):
        ...
        if flat_masks:
            with torch.no_grad():
                ...
                for start in range(0, len(flat_masks), bs2):
                    ...
                    probs2 = torch.sigmoid(outputs2.logits)
        ...
        total_loss = self.cls_loss_weight_1 * cls_loss_1 + norm_loss_1
