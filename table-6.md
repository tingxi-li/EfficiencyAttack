...
| # | Config | Wall Time | Throughput | Avg E2E Latency | LPR workload | #Drops | Total FLOPs |
|---|--------|-----------|------------|-----------------|-----------|----------|-------------|
| 1 | **Clean** | 17.3s | 0.578 img/s | 1.23s | 6 | 0 | 3.27T |
| 2 | **Attacked** | 1805s | 0.006 img/s | 503.4s | 9,315 | 0 | 215.3T |
| 3 | + conf=0.5 | 1084s | 0.009 img/s | 373.1s | 5,576 | 0 | 129.6T |
| 4 | + conf=0.5 + batch=16 | 550s | 0.018 img/s | 188.1s | 5,576 | 0 | 129.6T |
| 5 | + batch=16 + buffer=100 | 28.3s | 0.354 img/s | 8.0s | 304 | 9,011 | 8.96T |
| 6 | + conf=0.5 + buffer=100 | 34.3s | 0.291 img/s | 15.0s | 215 | 5,361 | 6.87T |
| 7 | + conf=0.5 + batch=16 + buffer=100 | 25.3s | 0.396 img/s | 7.7s | 199 | 5,377 | 6.50T |
| — | Clean (buffer=100) | 18.2s | 0.550 img/s | 1.25s | 6 | 0 | 3.27T |
