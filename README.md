...
| DeepLabV3-ResNet50 (License Plate Recognition) | ~166.0 | ~332.0 | ~332.0 |
| GIT-base prefill (Image Captioning) | ~27.1 | ~54.2 | ~90.8 |
| GIT-base AR decode (×10 tokens) |  ~18.4 | ~36.8 | |
| GPT2Tokenizer + SQLite3 (Knowledge Retrieval) | negligible | negligible | ≈0 |
| UDP (Data Uploading) |  negligible | negligible | ≈0 |
